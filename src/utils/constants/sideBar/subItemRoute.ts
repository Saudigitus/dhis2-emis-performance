...
export const subItemRoute = (location:string, sectionType: string, filterDataElements : filterItem[], removeParams?: boolean, isPerformance?: boolean) => {
    ...
    return isPerformance ? newLocation.toString() : removeQueryParam(newLocation, "programStage").toString();
};
